      ...
      <div className="sticky top-0 z-40 bg-white dark:bg-slate-900/80 backdrop-blur-xl border-b border-slate-300/50 dark:border-slate-700/50 shadow-sm">
        <div className="max-w-2xl mx-auto px-4 sm:px-6 h-16 flex items-center gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-base font-bold text-slate-900 dark:text-white leading-none">Add Expense</h1>
              <p className="text-xs text-slate-600 dark:text-slate-400 leading-none mt-0.5">Track your spending</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <form onSubmit={handleSubmit} noValidate className="space-y-5">
          ...
          <div className="bg-slate-100/60 dark:bg-slate-800/60 rounded-2xl border border-slate-300 dark:border-slate-700 divide-y divide-slate-700/50">
            ...
            <div className="px-6 py-5">
              ...
              {seedLoading ? (
                <div className="flex items-center gap-2 text-sm text-slate-600 dark:text-slate-400 py-3">
              ...
              <div className="px-6 py-5 space-y-4">
                    ...
                    {['daily', 'weekly', 'monthly', 'yearly'].map((f) => (
                      <button
                        ...
                        className={`py-2 rounded-xl text-xs font-bold capitalize border transition-all duration-150 ${
                          frequency === f
                            ? 'bg-violet-600 border-violet-600 text-slate-900 dark:text-white shadow-md'
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 rounded-xl border border-slate-600 text-sm font-medium text-slate-800 dark:text-slate-200 [color-scheme:dark] outline-none transition-all focus:ring-2 focus:ring-violet-400/20 focus:border-violet-400 bg-slate-200/50 dark:bg-slate-700/50"
                  />
                </div>

...
export default function ExpenseCategoryPage() {
  ...
  const [editingData, setEditingData] = useState({ name: '', color: '#3b82f6' });
  ...
  const handleRestoreDefaults = async () => {
    setSubmitting(true);
    try {
      await restoreDefaultCategories('/expense-categories');
      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="text-base sm:text-lg text-gray-600 max-w-2xl mx-auto">
            Organize your expenses with custom categories. Choose unique colors to easily
          ...
          >
            ...
            <div className="mt-8 p-4 bg-blue-50 rounded-xl border border-blue-100">
              ...
              <ul className="text-xs text-blue-700 space-y-1">
                ...
                <li>• Use consistent category names for accurate tracking</li>
              </ul>
            </div>
          </motion.div>
        </div>

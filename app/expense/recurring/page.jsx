        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 h-16 flex items-center gap-4">
          ...
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 rounded-xl bg-gradient-to-br from-violet-500 to-purple-600 flex items-center justify-center shadow-lg shadow-violet-500/20">
              <Repeat className="w-4 h-4 text-slate-900 dark:text-white" />
            </div>
            <div>
              <h1 className="text-base font-bold text-slate-900 dark:text-white leading-none">Recurring Expenses</h1>
          ...
          <div className="ml-auto">
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 bg-violet-600 hover:bg-violet-500 text-slate-900 dark:text-white text-sm font-bold rounded-xl transition-colors"
            >
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-8 space-y-8">
        {loading ? (
          ...
          >
            ...
            <h3 className="text-2xl font-bold text-slate-900 dark:text-white mb-2">No recurring expenses</h3>
            <p className="text-slate-600 dark:text-slate-400 mb-6">Toggle "Recurring" when adding an expense to set one up.</p>
            <button
              onClick={() => router.push('/expense/add')}
              className="px-6 py-3 bg-violet-600 hover:bg-violet-500 text-slate-900 dark:text-white font-bold rounded-2xl transition-colors"
            >

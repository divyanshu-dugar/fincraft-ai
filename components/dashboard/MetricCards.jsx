...
export function MetricCards({ dashboardData, timeRange, formatCurrency, formatPercentage }) {
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
      {/* Income Card */}
      <div className="bg-gradient-to-br from-slate-800/80 to-emerald-500/5 rounded-2xl border border-emerald-500/20 p-6 shadow-lg hover:shadow-emerald-500/10 transition-all duration-300">
      ...
      {/* Expenses Card */}
      <div className="bg-gradient-to-br from-slate-800/80 to-blue-500/5 rounded-2xl border border-blue-500/20 p-6 shadow-lg hover:shadow-blue-500/10 transition-all duration-300">
        <div className="flex items-center justify-between mb-4">
      ...
      {/* Net Cash Flow Card */}
      <div className="bg-gradient-to-br from-slate-800/80 to-purple-500/5 rounded-2xl border border-purple-500/20 p-6 shadow-lg hover:shadow-purple-500/10 transition-all duration-300">
        <div className="flex items-center justify-between mb-4">
      ...
      <div className="bg-gradient-to-br from-slate-800/80 to-cyan-500/5 rounded-2xl border border-cyan-500/20 p-6 shadow-lg hover:shadow-cyan-500/10 transition-all duration-300">
        <div className="flex items-center justify-between mb-4">
        ...
        <p className="text-slate-400 text-sm">Financial Health</p>
        <div className="mt-4 pt-4 border-t border-slate-700/50">

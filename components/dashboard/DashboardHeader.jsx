    ...
    <div className="sticky top-0 z-40 bg-slate-900/80 backdrop-blur-xl border-b border-cyan-400/10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-3 py-2 bg-slate-700 border border-slate-600 text-slate-200 rounded-lg focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500 [color-scheme:dark]"
                        max={
                          customEndDate ||
                  ...
                  <div className="mt-4 pt-4 border-t border-slate-700">
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      <button
                        ...
                        className="text-xs px-3 py-1.5 text-slate-400 bg-slate-700/50 hover:bg-slate-700 rounded-lg transition-colors"
                      >
                        Last 30 Days
                      </button>
                      <button
        ...
        {timeRange === "custom" && customStartDate && customEndDate && (
          <div className="flex items-center text-sm text-slate-400 pb-2">

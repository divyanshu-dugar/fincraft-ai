  ...
  if (categories.length === 0) {
    return (
      <div className="text-center py-12">
        ...
        <p className="text-sm text-gray-400 mb-6">Create your first category or restore the defaults</p>
        {onRestore && (
          <button
            onClick={onRestore}
            disabled={isRestoring}
            className="px-6 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition-colors font-medium disabled:opacity-50 disabled:cursor-not-allowed inline-flex items-center"
          >
            {isRestoring ? (
              <>

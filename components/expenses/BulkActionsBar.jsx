  ...
  return (
    ...
    >
      <div className="max-w-4xl mx-auto px-4 pb-4">
        <div className="bg-white dark:bg-slate-900/95 backdrop-blur-xl border border-blue-500/30 rounded-2xl shadow-2xl shadow-blue-500/10 p-4">
          {/* Main bar */}
                ...
                <div className="pt-4 mt-4 border-t border-slate-300/60 dark:border-slate-700/60 flex items-center gap-3">
                  ...
                  <div className="relative flex-1 max-w-sm">
                    <select
                      ...
                      className="w-full appearance-none bg-slate-100 dark:bg-slate-800 border border-slate-600 text-slate-900 dark:text-white text-sm rounded-xl px-4 py-2.5 pr-10 focus:outline-none focus:border-blue-500 transition-colors"
                    >
              ...
              >
                <div className="pt-4 mt-4 border-t border-slate-300/60 dark:border-slate-700/60 flex items-center gap-3">
                  ...
                  <input
                    ...
                    className="bg-slate-100 dark:bg-slate-800 border border-slate-600 text-slate-900 dark:text-white text-sm rounded-xl px-4 py-2.5 focus:outline-none focus:border-blue-500 transition-colors"
                  />
                  <motion.button
                    whileHover={{ scale: 1.02 }}
                    whileTap={{ scale: 0.98 }}

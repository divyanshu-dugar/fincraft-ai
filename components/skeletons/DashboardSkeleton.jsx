...
export default function DashboardSkeleton() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 pb-20 py-20 animate-pulse">
      {/* Header bar */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          {/* Category breakdown */}
          <div className="lg:col-span-2 bg-slate-800/60 rounded-2xl border border-slate-700/50 p-6 space-y-4">
          ...
          <div className="space-y-8">
            <div className="bg-slate-800/60 rounded-2xl border border-slate-700/50 p-6 space-y-3">
            ...
            <div className="bg-slate-800/60 rounded-2xl border border-slate-700/50 p-6 space-y-3">
              ...
              <div className="h-20 bg-slate-700/40 rounded-xl" />
            </div>
          </div>
        </div>

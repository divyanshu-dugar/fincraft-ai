  ...
  return (
    ...
    >
        ...
        <div className="bg-slate-900/95 backdrop-blur-xl border border-emerald-500/30 rounded-2xl shadow-2xl shadow-emerald-500/10 p-4">
          ...
          <div className="flex items-center justify-between gap-3">
            <div className="flex items-center gap-3">
              <span className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-emerald-500/20 border border-emerald-400/40 text-emerald-300 text-sm font-bold">
      ...
      <ConfirmDeleteModal
        ...
        loading={loading}
        title={`Delete ${selectedCount} Income${selectedCount > 1 ? 's' : ''}`}
        message={`Are you sure you want to delete ${selectedCount} income${selectedCount > 1 ? 's' : ''}? This cannot be undone.`}
      />
    </motion.div>
  );
}

  ...
  if (!incomes || incomes.length === 0) {
    return (
      <motion.div
        ...
        className="bg-slate-100/60 dark:bg-slate-800/60 rounded-3xl text-center py-20 border border-cyan-400/20"
      >
                          ...
                          return (
                            ...
                            >
                              <td className="px-3 py-4">
                                ...
                                >
                                  {selectedIds.has(income._id) && <Check size={12} className="text-slate-900 dark:text-white" strokeWidth={3} />}
                                </button>
                              </td>
                              ...
                              <td className="px-4 lg:px-6 py-4">
                                <div className="flex items-center gap-2">
                                  <motion.button
                                    ...
                                    className="relative p-2 bg-slate-200/50 dark:bg-slate-700/50 text-emerald-400 rounded-lg border border-emerald-500/30 hover:bg-emerald-500/15 hover:border-emerald-500/50 transition-all duration-200 group/btn"
                                  ...
                                  <motion.button
                                    ...
                                    className="relative p-2 bg-slate-200/50 dark:bg-slate-700/50 text-rose-400 rounded-lg border border-rose-500/30 hover:bg-rose-500/15 hover:border-rose-500/50 transition-all duration-200 group/btn"
                    ...
                    {dailyIncomes.map((income, incomeIndex) => {
                      ...
                      return (
                        <motion.div
                          ...
                          className={`bg-slate-100/60 dark:bg-slate-800/60 rounded-xl border p-4 ${selectedIds.has(income._id) ? "border-emerald-500/40 bg-emerald-500/10" : "border-slate-300 dark:border-slate-700"}`}
                        >
